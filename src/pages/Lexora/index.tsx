  ...
  return <div className="overflow-hidden bg-ts-canvas text-ts-ink">
    <section className="relative">
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:px-12 md:py-28 lg:gap-20">
        ...
        <div className="relative mx-auto w-full max-w-[640px] self-center"><img src="/assets/lexora/ai-result.jpg" alt="Lexora 浏览器扩展解读界面" className="relative w-full rounded-2xl bg-ts-surface/60 backdrop-blur-2xl shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl" /></div>
      </div>
    </section>
