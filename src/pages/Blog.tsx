          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {posts.map((post) => (
                <div 
                  key={post.id}
                  className="card p-8 flex flex-col gap-6 hover:shadow-md transition-all duration-300 group relative overflow-hidden bg-ts-surface dark:bg-ts-surface"
                >
                  <div className="space-y-3 flex-1">
                    ...
                    <button
                      ...
                      className="text-left block group/title text-xl font-bold text-ts-ink dark:text-white leading-snug hover:text-ts-primary transition-colors cursor-pointer"
                    >
                      {post.title}
                    </button>
                  ...
                  {/* Tags & Action Buttons */}
                  <div className="flex items-center justify-between pt-4 border-t border-ts-hairline dark:border-ts-navy-700">
