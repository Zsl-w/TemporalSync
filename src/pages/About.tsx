...
export const About = () => {
  ...
  useGSAP(() => {
    if (!projectSectionRef.current || !pinContainerRef.current) return;
    ...
    gsap.set('.project-stage', { display: 'flex', autoAlpha: 0, scale: 0.96, y: 10 });
  ...
  return (
    <div ref={containerRef} className="relative flex flex-col overflow-hidden">
      ...
      <section ref={projectSectionRef} className="projects-pinned-section">
        <div ref={pinContainerRef} className="projects-pinned-container">
          
          {/* Stage 1: TSync Studio */}
          <div className="project-stage stage-studio">
          ...
          {/* Stage 2: TSync Atlas */}
          <div className="project-stage stage-atlas">
            <div className="project-layout">
              <div className="project-info">
