...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    const needsReinitKeys: ('antialias' | 'liquid' | 'noiseAmount')[] = ['antialias', 'liquid', 'noiseAmount'];
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          composer.passes.forEach(p => {
            const passWithEffects = p as any;
            const effs = passWithEffects.effects as Effect[] | undefined;
            if (effs)
              effs.forEach(eff => {
